...
# set ironmunge icon
rcedit pub-win-x64/ironmunge/ironmunge.exe --set-icon pub-win-x64/Resources/ironmunge.ico
rcedit pub-win-x86/ironmunge/ironmunge.exe --set-icon pub-win-x86/Resources/ironmunge.ico

# set SaveManager icon
rcedit pub-win-x64/SaveManager/SaveManager.exe --set-icon pub-win-x64/Resources/savemanager.ico
rcedit pub-win-x86/SaveManager/SaveManager.exe --set-icon pub-win-x86/Resources/savemanager.ico
