...
# set ironmunge icon
./rcedit.exe pub-win-x64/ironmunge/ironmunge.exe --set-icon pub-win-x64/Resources/ironmunge.ico
./rcedit.exe pub-win-x86/ironmunge/ironmunge.exe --set-icon pub-win-x86/Resources/ironmunge.ico

# set SaveManager icon
./rcedit.exe pub-win-x64/SaveManager/SaveManager.exe --set-icon pub-win-x64/Resources/savemanager.ico
./rcedit.exe pub-win-x86/SaveManager/SaveManager.exe --set-icon pub-win-x86/Resources/savemanager.ico
